...
class MsProduct extends Model {
	...
	public function saveProduct($data) {
		...
		foreach ($data['languages'] as $language_id => $language) {
			$meta_title = isset($language['product_meta_title']) ? htmlspecialchars(nl2br($language['product_meta_title']), ENT_COMPAT) : '';
	...
	public function editProduct($data) {
		...
		foreach ($data['languages'] as $language_id => $language) {
            $included_field_sql = '';
			isset($language['product_meta_title']) ? $included_field_sql .= " meta_title = '". $this->db->escape(htmlspecialchars(nl2br($language['product_meta_title']), ENT_COMPAT)) ."',"  : '';
